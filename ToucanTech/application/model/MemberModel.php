...
class MemberModel extends BaseModel{
    ...
    public function ajaxSearchStudentModel($search){
        ...
        $stmt = $this->db->prepare("SELECT * FROM student JOIN school ON student.student_id = school.student_id WHERE school.school_name = :search ");
        ...
        //SELECT * FROM student FULL OUTER JOIN school ON student.student_id = school.student_id WHERE school.school_name = :search
